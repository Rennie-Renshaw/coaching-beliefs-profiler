...
function makeReport(data){
  ...
  function ocard(k,raw,isDom,is2nd){const od=OD[k],sc=Math.round(raw*100)+"%",op=isDom?"1":is2nd?"0.82":"0.55";let s="<div style='background:#1a1a1a;border-radius:12px;padding:18px 20px;margin-bottom:12px;border-left:4px solid "+od.color+";opacity:"+op+"'><div style='display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:8px'><span style='font-size:14px;font-weight:800;color:"+od.color+"'>"+od.label+"</span><span style='font-size:11px;color:#94a3b8'>("+sc+")</span>";if(isDom)s+="<span style='font-size:10px;background:"+od.color+"33;color:"+od.color+";padding:2px 8px;border-radius:10px'>Dominant</span>";if(is2nd)s+="<span style='font-size:10px;background:#44444433;color:#888;padding:2px 8px;border-radius:10px'>2nd</span>";s+="</div><p style='font-size:13px;color:#cbd5e1;line-height:1.7;margin-bottom:10px'>"+od.desc+"</p><ul style='list-style:none;padding:0'>"+od.bullets.map(b=>"<li style='font-size:12px;color:#94a3b8;margin-bottom:4px;padding-left:12px;position:relative'><span style='position:absolute;left:0;color:"+od.color+"'>·</span>"+b+"</li>").join("")+"</ul></div>";return s;}
